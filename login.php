...
<body class="bg-gradient-to-r from-slate-700 via-slate-900 to-black flex items-center h-screen">
    <div class="w-full max-w-sm mx-auto overflow-hidden rounded-lg shadow-md bg-gray-800">
        ...
        <img src="logo.png" width="100px" class="mx-auto mb-2">
            <h2 class="text-3xl font-bold text-center text-gray-700 dark:text-white">Buku Tamu</h2>
            ...
            <form method="POST">
                ...
                <div class="flex items-center mt-4">
                    <input class="px-4 py-2 leading-5 text-white bg-gradient-to-r from-green-700 to-yellow-600 hover:from-slate-500 rounded cursor-pointer hover:bg-gray-600 focus:outline-none ml-auto" type="submit" name="login" value="Masuk">
                </div>
            </form>
        </div>
